...
structureDef
   : actionDef | durativeActionDef | derivedDef | methodDef
   ;
...
methodDef
   : '(' ':' METHOD actionSymbol ':' PARAMETERS '(' typedVariableList ')' ':' EXPANSION '(' taskList ')' ':' CONSTRAINTS '(' constraintList ')' ')'
   ;
